...
// @version      3.0
// @description  TRMAP
// @author       Emir Kaya Discord:EmirR
// @match        https://pixelzone.io/*
// @match        http://pixelzone.io/*
// @homepage     https://github.com/Emir2k18/TrarMYMaP/
// @updateURL    https://raw.githubusercontent.com/Emir2k18/TrarMYMaP/master/minimap.user.js
// @downloadURL  https://raw.githubusercontent.com/Emir2k18/TrarMYMaP/master/minimap.user.js
// @grant        none
// ==/UserScript==
...
var range = 25;
window.baseTepmlateUrl = 'https://raw.githubusercontent.com/Emir2k18/TrarMYMaP/master/';
...
window.addEventListener('load', function () {
    ...
    div.innerHTML = '<div id="minimapbg" style="position: absolute; right: 1em; bottom: 1em;">' +
        '<div class="posy" id="posyt" style="background-size: 97%; background-image: url(https://66.media.tumblr.com/f65e5b5e0497a84ced351121374dba54/tumblr_ootgnfsdv81ud0flpo1_r1_500.gif); color: rgb(250, 250, 250); text-align: center; line-height: 42px; vertical-align: middle; width: auto; height: auto; border-radius: 21px; padding: 6px;">' +
        ...
        '<span id="hide-map" style="cursor:pointer;">Haritayi Gizle' +
...
function toggleShow() {
    ...
    if (toggle_show) {
        ...
        document.getElementById("minimap-config").style.display = "none";
        document.getElementById("minimap-text").style.display = "block";
        document.getElementById("minimap-text").innerHTML = "Haritayi Göster";
        document.getElementById("minimapbg").onclick = function () {
            toggleShow()
        };
    }
